...
import_module("ctac.tool.commands_prj")
...
import_module("ctac.tool.commands_sbf_tac")
...
import_module("ctac.tool.commands_strip")
...
import_module("ctac.tool.commands_cover_cfg")
