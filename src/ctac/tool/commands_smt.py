...
_SMT_EPILOG = (
    ...
    "+ range-axiom support. It is the default; [cyan]sea_gate[/cyan] (used "
    "by [cyan]--coi[/cyan]), [cyan]sea[/cyan], and [cyan]leino[/cyan] are "
    "also registered and selectable via [cyan]--encoding[/cyan].\n\n"
    ...
    "Critical edges are split automatically. Any bytemap capability "
    "([cyan]bytemap-rw[/cyan] included) is supported.\n\n"
