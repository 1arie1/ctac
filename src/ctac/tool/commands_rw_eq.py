...
_RW_EQ_EPILOG = (
    ...
    "[bold green]Inputs contract[/bold green]  Two shapes are "
    "accepted. [cyan]Lockstep[/cyan]: the same block ids in the same "
    "order with the same successor list per block. [cyan]Stuttering"
    "[/cyan]: rw's block ids are a proper subsequence of orig's (rw "
    "produced by a structural reduction); the walker decomposes at "
    "divergence/sync points. Inputs that are neither shape are "
    "rejected with an [cyan]EquivContractError[/cyan]. "
