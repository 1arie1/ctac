...
_PRJ_EPILOG = (
    ...
    "[cyan]base.rw.ua.tac[/cyan], ...).\n\n"
    "[bold green]Phase 1 surface[/bold green]  "
    "[cyan]ctac prj init[/cyan] / [cyan]list[/cyan] / [cyan]info[/cyan]. "
    "Existing TAC commands ([cyan]rw[/cyan], [cyan]ua[/cyan], "
    "[cyan]smt[/cyan], [cyan]pp[/cyan]) do NOT yet accept a project "
    "directory in place of a [cyan].tac[/cyan] argument; that's "
    "phase 2. Today, run them on the explicit object path "
    "([cyan]mytac/base.tac[/cyan]) and re-add the result with a "
    "follow-up library call.\n\n"
