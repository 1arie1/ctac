...
_RW_VALID_EPILOG = (
    ...
    "Covers the algebraic div rules (R1, R4 x5, R4a, R6, ADD_BV_MAX_TO_ITE) "
    "and the sign-extension gadget family (NegS64* zero/sign/chunk/double "
    "tests, WrapCompareLift, FromS64ZeroTest, ModDivPin, CarryChunkCancel, "
    "the +1 and band-lift consumers), plus EqSubZero and NegS128Recombine — "
    "the gadget lemmas are width-parametrized (cases [cyan]w64/w128/w256[/cyan]). "
